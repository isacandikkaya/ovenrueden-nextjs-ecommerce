      ...
      <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
        ...
        <div className="md:mt-24 f-f-p">
          ...
          <div className="md:hidden flex flex-col items-center w-full">
            ...
            <div className="mt-10">
              <h1 className="text-xl tracking-wide text-center leading-5 font-bold">Choose a plan</h1>
              <h2 className="text-gray-500 mt-3 pl-3 text-center text-base leading-6 tracking-wide">Choose a plan and add a payment method </h2>
            </div>
            ...
            <div className="flex mt-10 flex-col items-center md:items-start md:w-8/12">
              <h1 className="text-xl text-center tracking-wide leading-5 font-bold">Start your Journey</h1>
